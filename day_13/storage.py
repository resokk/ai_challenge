...
class UserStore:
    ...
    def load_todo(self, user_id: int, task_id: str) -> str | None:
        """What is still outstanding on this task, or None if nothing is noted."""
        return self._task_column("todo", user_id, task_id)

    def save_todo(self, user_id: int, task_id: str, todo: str) -> None:
        """Replace what this task still has outstanding."""
        self._set_task_column("todo", user_id, task_id, todo)
