# Day 2 — Telegram Bot (improved)

Same base as [day_1](../day_1): a Telegram bot built with [python-telegram-bot](https://docs.python-telegram-bot.org/), with chat replies powered by the [DeepSeek API](https://platform.deepseek.com/) (OpenAI-compatible). This version adds per-chat system prompt customization and usage stats.
