...
def _task_text_command(field: str, note=None):
    ...
    reply once it has changed - the todo offers the next state, rules nothing."""
...
def main() -> None:
    ...
    application.add_handler(CommandHandler("todo", _task_text_command("todo", _all_done_note)))
